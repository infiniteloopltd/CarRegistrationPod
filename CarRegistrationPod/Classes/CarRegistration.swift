...
{
    let url = URL(string: "https://www.regcheck.org.uk/api/json.aspx/CheckAustralia/" + registrationNumber + "/" + state)
...
{
    let url = URL(string: "https://www.regcheck.org.uk/api/json.aspx/CheckUSA/" + registrationNumber + "/" + state)
    return lookup(url: url!, username: username, password: password )
}
...
{
    let url = URL(string: "https://www.regcheck.org.uk/api/json.aspx/" + endpoint + "/" + registrationNumber)
    return lookup(url: url!, username: username, password: password )
}
